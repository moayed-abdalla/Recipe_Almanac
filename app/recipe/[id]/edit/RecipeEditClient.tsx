...
export default function RecipeEditClient({
  ...
  // Form state - recipe metadata (pre-filled with existing data)
  const [title, setTitle] = useState(recipe.title);
  const [description, setDescription] = useState(recipe.description || '');
  const [tags, setTags] = useState(recipe.tags.join(', '));
  const [isPublic, setIsPublic] = useState(recipe.is_public);
  
  // Form state - recipe content (pre-filled with existing data)
  ...
  // Form state - ingredients (pre-filled with existing data)
